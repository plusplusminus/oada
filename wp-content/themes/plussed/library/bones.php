...
return '...</p><p><a class="excerpt-read-more view-more" href="'. get_permalink($post->ID) . '" title="'. __( 'Read', 'bonestheme' ) . get_the_title($post->ID).'">'. __( 'View More', 'bonestheme' ) .' <span class="fa fa-angle-right"></span></a>';
}
