...
return '...</p><p><a class="excerpt-read-more" href="'. get_permalink($post->ID) . '" title="'. __( 'Read', 'bonestheme' ) . get_the_title($post->ID).'">'. __( 'Find Out More', 'bonestheme' ) .' <span class="fa fa-angle-right"></span></a>';
}
