	...
	var $window = $( window ),
		...
		_createSingleViewNavigation = function() {
			...
			if( Gamma.itemsCount > 1 ) {
				...
				Gamma.nav = $( '<nav class="gamma-nav"><span class="fa fa-chevron-left gamma-prev"></span><span class="fa fa-chevron-right gamma-next"></span></nav>' ).appendTo( Gamma.singleview );
