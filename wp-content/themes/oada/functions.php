...
function trips_post_example() { 
    ...
    register_post_type( 'gallery', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
        ...
        array( 'labels' => array(
            ...
            'edit' => __( 'Edit', 'bonestheme' ), /* Edit Dialog */
            'edit_item' => __( 'Edit Gallery Types', 'bonestheme' ), /* Edit Display Title */
            'new_item' => __( 'New Gallery Type', 'bonestheme' ), /* New Display Title */
            'view_item' => __( 'View Gallery Type', 'bonestheme' ), /* View Display Title */
            'search_items' => __( 'Search Gallery Type', 'bonestheme' ), /* Search Custom Type Title */ 
            'not_found' =>  __( 'Nothing found in the Database.', 'bonestheme' ), /* This displays if there are no entries yet */ 
            'not_found_in_trash' => __( 'Nothing found in Trash', 'bonestheme' ), /* This displays if there is nothing in the trash */
            'parent_item_colon' => ''
            ), /* end of arrays */
